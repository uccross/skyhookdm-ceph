...
def main():
    ...
    # TODO: Formatting for changings options and using SQL files
    # print("Enter 'options' to change options. Enter 'file [file_1] ...' to use one or more SQL files.") 
    ...
    while True:
        ...
        if 'describe table' in rawUserInput:
            ...
            showTableSchema = "bin/run-query --num-objs 2 --pool tpchdata --oid-prefix \
                                \"public\" --table-name \"{0}\" --header --limit 0".format(tableName)
