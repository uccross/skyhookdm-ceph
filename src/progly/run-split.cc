...
int main(int argc, char **argv)
{
  ...
  std::vector< dataset_split > table_split_12 ;
  ...
  assert( decoded_id1_blist_in[0].toString()   == "dataset_split :  t, 1  e, 1  s, 1  t, 1  s, 1  t, 1  r, 1" ) ;
  assert( decoded_id1_blist_out0[0].toString() == "dataset_split :  t, 1  e, 1  s, 1" ) ;
  assert( decoded_id1_blist_out1[0].toString() == "dataset_split :  t, 1  s, 1  t, 1  r, 1" ) ;
  ...
  dataset_split ds_split_pattern ;
  ...
  std::vector< dataset_split > table_split_pattern ;
  ...
  assert( decoded_id2_blist_in[0].toString()   == "dataset_split :  t, 1  e, 1  s, 1  t, 1  s, 1  t, 1  r, 1" ) ;
  assert( decoded_id2_blist_out0[0].toString() == "dataset_split :  t, 1  e, 1" ) ;
  assert( decoded_id2_blist_out1[0].toString() == "dataset_split :  s, 1  t, 1  s, 1  t, 1  r, 1" ) ;
  ...
  std::vector< dataset_split > table_split_noop ;
