...
#set -e
objfile="fbx.${lineitem_10MB_fname_base}"
groupsize=15
nobjs=1
...
objfile="arrow.${lineitem_10MB_fname_base}"
...
#set -e
objfile="fbx.${lineitem_100MB_fname_base}"
groupsize=15
nobjs=1
groupsize=$(( groupsize < nobjs ? groupsize : nobjs ))
for ((i=0; i < $nobjs; i+=groupsize)); do
...
###############
###############  RETRIEVE LINEITEM arrow  obj
objfile="arrow.${lineitem_100MB_fname_base}"
rados get --pool $pool obj.0  $objfile
#############################################################
#############################################################
...
# set -e
objfile="fbx.${ncols100_10MB_fname_base}"
pool="ncols100"
groupsize=15
nobjs=1
groupsize=$(( groupsize < nobjs ? groupsize : nobjs ))
...
objfile="arrow.${ncols100_10MB_fname_base}"
rados get --pool $pool obj.0  $objfile
#############################################################
#############################################################
...
# set -e
objfile="fbx.${ncols100_100MB_fname_base}"
pool="ncols100"
groupsize=15
nobjs=1
groupsize=$(( groupsize < nobjs ? groupsize : nobjs ))
...
###############
###############  RETRIEVE NCOLS100  arrow  obj
objfile="arrow.${ncols100_100MB_fname_base}"
rados get --pool $pool obj.0  $objfile
#############################################################
#############################################################
