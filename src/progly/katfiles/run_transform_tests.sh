...
for ((group_id=0; group_id<${number_of_write_groups}; group_id++)); do
...
#echo "Command ran: ${cmd5}" >> ${HOME}/copyfromappend_merge_time_results.txt
...
#echo "Command ran: ${cmd6}" >> ${HOME}/clientmerge_time_results.txt
